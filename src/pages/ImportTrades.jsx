...
const ImportTrades = () => {
  ...
  const handleImport = async () => {
    ...
    if (errors === 0) {
      navigate("https://tradingjournalv2imron.vercel.app/"); // Redirect to the main page (/)
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 sm:p-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            onClick={() => navigate("https://tradingjournalv2imron.vercel.app/")} // Navigate to the main page (/)
