...
const TradeWinPercentCard = ({ value, customBg }) => {
  ...
  return (
    <div
      className={`p-6 rounded-xl shadow-sm min-w-[200px] flex-1 h-24 flex flex-col justify-between hover:shadow-md hover:scale-[1.02] transition-all duration-200 ${customBg}`}
    >
