...
const RecentTradesCard = ({ trades = [] }) => {
  ...
  return (
    ...
    >
      ...
      {/* Column Headers */}
      <div className="flex justify-between items-center p-3 bg-gray-200 dark:bg-zinc-700 text-gray-700 dark:text-gray-300 font-semibold rounded-t-lg">
      ...
      {/* Trade List */}
      <div className="flex-1 overflow-y-auto space-y-2 pr-2 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-zinc-600 scrollbar-track-transparent">
